    ...
    },
    {
      content: (
        <Typography variant="body">
          ...
          einem hybriden Arbeitsmodell tätig zu sein, was auf einen hohen Bedarf
          an Verbindungen außerhalb der physischen Büros hinweist.
        </Typography>
      ),
    },
    {
      content: (
        <Typography variant="body">
          ...
          sich nur teilweise gut vernetzt, wobei 19 Kontakte als „oberflächlich“
          beschrieben wurden.
        </Typography>
      ),
    },
  ...
  const keyInsights = [
    {
      content: (
        <Typography variant="body">
          🔍 <strong>Top Insight 1:</strong> „Die meisten meiner Kontakte sind
          oberflächlich“ wurde von 19 Personen angegeben – ein klares Signal für
          die Relevanz von KIM.
        </Typography>
      ),
    },
    {
      content: (
        <Typography variant="body">
          💡 <strong>Top Insight 2:</strong> 64 % der Teilnehmer zeigten
          Interesse an einer Plattform, die soziale Hemmungen abbaut und durch
    ...
    },
    {
      content: (
        <Typography variant="body">
          ⏳ <strong>Top Insight 3:</strong> „Unpersönliche Netzwerke“ und
          „Zeitmangel“ wurden mehrfach als Schmerzpunkte genannt.
        </Typography>
      ),
    },
  ];
