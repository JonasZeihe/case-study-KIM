  ...
  const features = [
    {
      content: (
        <>
          🤖 <HighlightText>KI-gestützter Chat:</HighlightText> Dynamische Persönlichkeitsprofile, die
          auf den Antworten des Nutzers basieren.
        </>
      ),
    },
    {
      content: (
        <>
          💡 <HighlightText>Gruppenvorschläge mit Kompatibilitätsscore:</HighlightText> Basierend auf
          dem Persönlichkeitsprofil zeigt KIM Gruppen mit hoher Übereinstimmung an.
        </>
      ),
    },
    {
      content: (
        <>
          ❄️ <HighlightText>Automatisierte Icebreaker:</HighlightText> Spannende Fragen erleichtern
          Gruppentreffen und brechen das Eis.
        </>
      ),
    },
    {
      content: (
        <>
          🎨 <HighlightText>Visuelles Design:</HighlightText> Moderne Farben und klare Typografie
